...
import com.ansdoship.carbonizedpixeldungeon.actors.mobs.Spinner;
...
import com.ansdoship.carbonizedpixeldungeon.sprites.FistSprite;
...
import com.ansdoship.carbonizedpixeldungeon.sprites.SpinnerSprite;
import com.ansdoship.carbonizedpixeldungeon.ui.Icons;
import com.ansdoship.carbonizedpixeldungeon.ui.TalentIcon;
...
public class v0_9_X_Changes {
	...
	public static void add_v0_9_2_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton(new ChangeButton(new TalentIcon(Talent.SHIELD_BATTERY), "On-Upgrade Talents",
