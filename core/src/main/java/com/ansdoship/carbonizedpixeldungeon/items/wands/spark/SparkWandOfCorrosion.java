...
import com.ansdoship.carbonizedpixeldungeon.effects.particles.CorrosionParticle;
...
public class SparkWandOfCorrosion extends SparkWand {

	{
		image = ItemSpriteSheet.SPARKWAND_CORROSION;
