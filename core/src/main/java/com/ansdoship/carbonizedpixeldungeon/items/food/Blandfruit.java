...
public class Blandfruit extends Food {
	...
	public String name() {
		...
		if (potionAttrib instanceof PotionOfPotential)       return Messages.get(this, "rotfruit");
	...
	public Item imbuePotion(Potion potion){
		...
		if (potionAttrib instanceof PotionOfPotential)       potionGlow = new ItemSprite.Glowing( 0xCC0022 );
