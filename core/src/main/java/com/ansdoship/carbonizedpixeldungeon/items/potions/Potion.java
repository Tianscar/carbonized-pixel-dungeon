...
import com.ansdoship.carbonizedpixeldungeon.items.ItemStatusHandler;
...
import com.ansdoship.carbonizedpixeldungeon.items.potions.exotic.PotionOfCorrosiveGas;
import com.ansdoship.carbonizedpixeldungeon.items.potions.exotic.PotionOfShroudingFog;
import com.ansdoship.carbonizedpixeldungeon.items.potions.exotic.PotionOfSnapFreeze;
...
public class Potion extends Item {
	...
	public static class SeedToPotion extends Recipe {
		...
		static {
			...
			types.put(Rotberry.Seed.class,      PotionOfPotential.class);
