...
public class ItemSpriteSheet {
	...
	public static final int WEAPON2_HOLDER  = PLACEHOLDERS+16;
	public static final int EXOTIC_HOLDER  = PLACEHOLDERS+17;
	static{
		...
		assignItemRect(WEAPON2_HOLDER,  16, 16);
		assignItemRect(EXOTIC_HOLDER,   12, 13);
	}

	private static final int UNCOLLECTIBLE  =                               xy(1, 2);   //32 slots
	...
	private static final int CONTAINERS     =                               xy(1, 3);   //32 slots
	...
	private static final int WEP_TIER3      =                               xy(1, 8);   //16 slots
	...
	private static final int MISSILE_WEP    =                               xy(1, 10);  //32 slots. 3 per tier + boomerang
	...
	public static final int TIPPED_DARTS    =                               xy(1, 11);  //32 slots
	...
	static {
		for (int i = TIPPED_DARTS; i < TIPPED_DARTS+32; i++)
			assignItemRect(i, 15, 15);
	}
	
	private static final int ARMOR          =                               xy(1, 12);  //32 slots
	...
	private static final int ARTIFACTS          =                            xy(1, 16);  //64 slots
	...
	private static final int SCROLLS        =                               xy(1, 19);  //32 slots
	...
	private static final int EXOTIC_SCROLLS =                               xy(1, 20);  //32 slots
	...
	static {
		for (int i = EXOTIC_SCROLLS; i < EXOTIC_SCROLLS+32; i++)
			assignItemRect(i, 15, 14);
	}
	
	private static final int STONES             =                           xy(1, 21);  //32 slots
	...
	static {
		for (int i = STONES; i < STONES+32; i++)
			assignItemRect(i, 14, 12);
	}

	private static final int POTIONS        =                               xy(1, 22);  //32 slots
	...
	private static final int EXOTIC_POTIONS =                               xy(1, 23);  //32 slots
	...
	static {
		for (int i = EXOTIC_POTIONS; i < EXOTIC_POTIONS+32; i++)
			assignItemRect(i, 12, 13);
	}

	private static final int SEEDS              =                           xy(1, 24);  //32 slots
	...
	static{
		for (int i = SEEDS; i < SEEDS+32; i++)
			assignItemRect(i, 10, 10);
	}
	
	private static final int BREWS          =                               xy(1, 25);  //16 slots
	...
	private static final int ELIXIRS        =                               xy(17, 25);  //16 slots
	...
	private static final int MATERIALS      =                               xy(1, 26);  //32 slots
	...
	private static final int QUEST  =                                       xy(1, 29);  //64 slots
	...
	private static final int BAGS       =                                   xy(1, 31);  //32 slots
	...
	public static class Icons {
		...
		public static final int POTION_POWER    = POTIONS+0;
		...
		static {
			assignIconRect( POTION_POWER,       7, 7 );
