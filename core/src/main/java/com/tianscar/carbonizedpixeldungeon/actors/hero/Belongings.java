...
public class Belongings implements Iterable<Item> {
	...
	public KindOfWeapon extra = null;
	...
	public KindOfWeapon extra(){
		...
		boolean lostInvent = owner != null && owner.buff(LostInventory.class) != null;
		if (!lostInvent || (extra != null && extra.keptThoughLostInvent)){
			return extra;
		} else {
			return null;
		}
	...
	public void restoreFromBundle( Bundle bundle ) {
		...
		extra = (KindOfWeapon) bundle.get(EXTRA);
		if (extra() != null) {
			extra().activate(owner);
		}
	...
	public void observe() {
		...
		if (extra() != null) {
			extra().identify();
			Badges.validateItemLevelAquired(extra());
		}
		if (armor() != null) {
			armor().identify();
	...
	public void uncurseEquipped() {
		ScrollOfRemoveCurse.uncurse( owner, armor(), weapon(), extra(), artifact(), misc(), ring());
	}
	...
	private class ItemIterator implements Iterator<Item> {
		...
		private Item[] equipped = {weapon, extra, armor, artifact, misc, ring};
