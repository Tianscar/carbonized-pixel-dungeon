...
public class ItemSpriteSheet {
	...
	public static final int ARTIFACT_OCARINA    = ARTIFACTS+23;
	static{
		assignItemRect(ARTIFACT_CLOAK,      9,  15);
		assignItemRect(ARTIFACT_ARMBAND,    14, 10);
		...
		assignItemRect(ARTIFACT_OCARINA,    10, 11);
	}
	...
	public static final int AQUA_BLAST      = SPELLS+6;
	public static final int FEATHER_FALL    = SPELLS+7;
