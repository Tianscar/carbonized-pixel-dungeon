...
package com.tianscar.carbonizedpixeldungeon.messages;

import java.util.Locale;

public enum Languages {
	ENGLISH("english",      "",   Status.REVIEWED,   new String[]{"Evan Debenham", "Watabou", "Karstian Lee"}, null),
	...
	SI_CHINESE("简体中文",   "zh", Status.REVIEWED, new String[]{"Jinkeloid(zdx00793)", "endlesssolitude"}, new String[]{"931451545", "Chronie_Lynn_Iwa", "Fatir", "Fishbone", "HoofBumpBlurryface", "Lery", "Lyn_0401", "Ooooscar", "ShatteredFlameBlast", "SpaceAnchor", "hmdzl001", "leo", "tempest102"}),
	TR_CHINESE("正體中文",   "tc", Status.UNREVIEWED, new String[]{"Karstian Lee"}, null),
	...
	public static Languages matchLocale(Locale locale){
		if (locale.getLanguage().equals("zh")) {
			return (locale.getCountry().equals("HK") || locale.getCountry().equals("MO") || locale.getCountry().equals("TW")) ?
					Languages.TR_CHINESE : Languages.SI_CHINESE;
		}
