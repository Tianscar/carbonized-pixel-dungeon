...
import com.tianscar.carbonizedpixeldungeon.actors.mobs.Spinner;
...
import com.tianscar.carbonizedpixeldungeon.sprites.SpinnerSprite;
...
public class v0_9_X_Changes {
	...
	public static void add_v0_9_2_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton(new ChangeButton(new TalentIcon(37, true), "On-Upgrade Talents",
		...
		changes.addButton(new ChangeButton(new TalentIcon(99, true), "Nature's Aid",
	...
	public static void add_v0_9_1_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton( new ChangeButton( new TalentIcon(0, true), "Hearty Meal",
