...
public class WndGardner extends Window {
	...
	public WndGardner(final Blueberries berries) {
		...
		titlebar.icon( new ItemSprite( berries.image(), null ) );
		titlebar.label( Messages.titleCase( berries.name() ) );
		...
		RedButton btnReward = new RedButton( Messages.get(this, "reward") ) {
			...
			protected void onClick() {
				...
				berries.detach( Dungeon.hero.belongings.backpack );

				Item reward = new Blandfruit();
